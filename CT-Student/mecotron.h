...
class MECOtron : public HALBase {
  ...
  public:
    ...
    inline void setVoltageMotorA(const float volts) { _motorA->setBridgeVoltage((int16_t)(1000*volts)); }
    inline void setVoltageMotorB(const float volts) { _motorB->setBridgeVoltage((int16_t)(1000*volts)); }
    inline float getPositionMotorA() { return _encoderA->readCalibratedValue(); }
    inline float getPositionMotorB() { return _encoderB->readCalibratedValue(); }
    inline float getSpeedMotorA() { return _speedA->readCalibratedValue(); }
    inline float getSpeedMotorB() { return _speedB->readCalibratedValue(); }
    inline float getFrontDistance() { return _distance1->readCalibratedValue(); }
    inline float getSideDistance()  { return _distance2->readCalibratedValue(); }
    inline float getPendulumAngle() {return _pendulum->readCalibratedValue(); }
